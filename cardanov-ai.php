        ...
        <div class="wrap">
            ...
            <?php if (empty($items)): ?>
                <div style="text-align: center; padding: 40px; background: #f8f9fa; border-radius: 4px; border: 1px solid #ddd;">
                    ...
                    <a href="<?php echo admin_url('admin.php?page=cardanov-ai-knowledge&action=edit'); ?>" class="button button-primary" style="margin-top: 15px;">➕ Добавить первую запись</a>
                </div>
            <?php else: ?>
                ...
                <div style="margin-top: 20px; padding: 10px; background: #f8f9fa; border-radius: 4px;">
                    <p><strong>💡 Совет:</strong> Для теста добавьте запись с вопросом "тест" и проверьте работу AI на сайте.</p>
                </div>
            <?php endif; ?>
        </div>
        <?php
